...
parser.add_argument('-pe', '--penalty', default='100', type=float,
                    help="Penalty rate. (Default: 0.0)")
...
def main():
    ...
    register(id='FrozenLakeNotSlippery-v0',
             ...
             max_episode_steps=args.maxstep,
             reward_threshold=0.78)

    env = gym.envs.make('FrozenLakeNotSlippery-v0')	
   ...
   ## env.monitor.close()
    ...
    fig.savefig('./'+result_dir+'-nonSlippery-penalty.png')
