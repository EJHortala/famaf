...
Necesitamos crear una funcion normalizacion en R. En este caso utilizaremos la función scale, para normalizar los datos en base a la media y la desviación estandar de cada indicador:
